...
void ClassManager::registerServer(IClassServer* server)
{
	...
	for (auto& regInfo : classRegInfos)
	{
		...
		{
			BF2_ERROR(
				"Duplicate registration of class id "
				<< regInfo.id << ". Already used by:" << classInfo.name
				<< " tried to set new name:" << regInfo.name);
		}
		if (getClassInfo(regInfo.name, classInfo))
		{
			BF2_ERROR(
				"Duplicate registration of class name \""
				<< regInfo.name << "\" exists already as: " << classInfo.name);
		}
...
bool ClassManager::getClassID(const std::string&, unsigned int&)
{
	// TODO: Implement
	return false;
}
...
IBase* ClassManager::createInstance(
	unsigned int cid, unsigned int iid, IBase* baseClass)
{
	ClassInfo info;
...
bool ClassManager::createInstance(const std::string&, unsigned int, IBase*)
{
	// TODO: Implement
	return false;
}

bool ClassManager::setSingletonClass(const std::string&, unsigned int)
{
	// TODO: Implement
	return false;
}

bool ClassManager::getSingletonClass(const std::string&, unsigned int&)
{
	// TODO: Implement
	return false;
}

void ClassManager::registerSingleton(const SingletonRegInfo& regInfo)
{
	// TODO: Implement
...
void ClassManager::unregisterSingleton(const std::string&)
{
	// TODO: Implement
}

void* ClassManager::getSingleton(const std::string&)
{
	// TODO: Implement
	return nullptr;
}

void* ClassManager::getSingletonAs(const std::string&, unsigned int)
{
	// TODO: Implement
	return nullptr;
}

void ClassManager::registerSimpleSingleton(const std::string&, void*)
{
	// TODO: Implement
}

void ClassManager::unregisterSimpleSingleton(const std::string&)
{
	// TODO: Implement
}

void* ClassManager::getSimpleSingleton(const std::string&) const
{
	// TODO: Implement
	return nullptr;
}
...
void ClassManager::getAllClassIncludingSubstring(
	const std::string&, std::vector<std::string>&) const
{
	// TODO: Implement
}
