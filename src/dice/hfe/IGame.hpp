...
namespace dice
{
    namespace hfe
    {
        ...
        public:
            ...
            virtual void* getObjectFromNetworkableId(uint16_t const&) = 0;
            ...
            virtual std::string const& listSquadMembers(int32_t, int32_t) = 0;
            virtual std::string const& listSquads(int32_t) = 0;
            ...
            virtual std::string const& getSpottedMessage(uint16_t) = 0;
            virtual void sendSpottedMessage(world::IPlayer*, uint16_t, Vec2, world::VehicleType) = 0;
            ...
            virtual std::string const& getCurrentMapName() const = 0;
            virtual std::string const& getCurrentMapGameMode() const = 0;
            virtual std::string const& getCurrentMapLevelPath() const = 0;
