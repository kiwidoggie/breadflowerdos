...
namespace dice
{
    namespace hfe
    {
        ...
        public:
            ...
            virtual void load() = 0;
            virtual void loadPath(std::string const&) = 0;
            ...
            virtual void localRadioMessage(TargetChannel, std::string const&) = 0;
            virtual void gameInfoMessage(TargetChannel, std::string const&, unsigned int, unsigned int, bool) = 0;
            virtual void localGameInfoMessage(TargetChannel, std::string const&) = 0;
