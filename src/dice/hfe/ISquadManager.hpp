...
namespace dice
{
    namespace hfe
    {
        ...
        public:
            ...
            virtual bool setSquadName(int32_t, int32_t, int32_t, std::string const&, bool) = 0;
            virtual bool setIsPrivate(int32_t, int32_t, bool, bool) = 0;
            virtual bool setIsAccepted(int32_t, int32_t, bool, OrderType, SquadOrderType, bool) = 0;
            ...
            virtual void issueCommanderOrder(int32_t, int32_t, SquadOrder&, bool) = 0;
