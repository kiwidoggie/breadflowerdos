...
namespace dice
{
    namespace hfe
    {
        ...
        public:
            ...
            virtual uint32_t postEventNextUpdate(EventCategory, uint32_t, void*) = 0;
            virtual bool processEvents(float) = 0;
            virtual void removePendingEvents() = 0;
            virtual bool removeEvent(uint32_t) = 0;
            virtual bool registerEventHandler(EventCategory, IEventListener*, int32_t) = 0;
            virtual bool unregisterEventHandler(EventCategory, IEventListener*) = 0;
            virtual bool registerEvent(EventCategory, uint32_t, std::string const&) = 0;
