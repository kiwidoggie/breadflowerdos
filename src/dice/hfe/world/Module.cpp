...
bool Module::init()
{
	 ...
	 * g_mainConsoleObjects->registerTypeConversion("IObject_ptrproxy",
	 * "object");

	 * g_mainConsoleObjects->registerTypeConversion("world::IObject*",
	 * "object");

	 * g_mainConsoleObjects->registerTypeConversion("world::IObject_ptrproxy",
	 * "object");

	 * g_mainConsoleObjects->registerTypeConversion("IObjectTemplate*",
	 * "objectTemplate");

	 * g_mainConsoleObjects->registerTypeConversion("IObjectTemplate_ptrproxy",
	 * "objectTemplate");

	 * g_mainConsoleObjects->registerTypeConversion("world::IObjectTemplate*",
	 * "objectTemplate");

	 * g_mainConsoleObjects->registerTypeConversion("world::IObjectTemplate_ptrproxy",
	 * "objectTemplate");
 g_mainConsoleObjects->registerTypeConversion("const
	 * IObjectTemplate*", "objectTemplate");

	 * g_mainConsoleObjects->registerTypeConversion("const
	 * IObjectTemplate_ptrproxy", "objectTemplate");

	 * g_mainConsoleObjects->registerTypeConversion("const
	 * world::IObjectTemplate*", "objectTemplate");
