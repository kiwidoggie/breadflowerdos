...
void ObjTemplBaseModule::getClassList(std::vector<ClassRegInfo>& regInfos)
{
    ...
    /*
    {
        auto regInfo = ClassRegInfo(CID_ObjectTemplateManager, "dice.hfe.world.ObjectTemplateManager.Standard", ClassFactory<ObjectTemplateManager>::create);
        regInfos.push_back(regInfo);
    }
    */
}

void ObjTemplBaseModule::getSingletonList([[maybe_unused]] std::vector<SingletonRegInfo>& regInfos)
{
}
