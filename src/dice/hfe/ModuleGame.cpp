...
void ModuleGame::getClassList(std::vector<ClassRegInfo>& regInfos)
{
    ...
    /*
    {
        auto regInfo = ClassRegInfo(CID_StatsManager, "dice.hfe.StatsManager", StatsManager::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_PlayerStatsManager, "dice.hfe.PlayerStatsManager", PlayerStatsManager::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_PlayerAwards, "dice.hfe.PlayerAwards", PlayerAwards::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_PlayerStats, "dice.hfe.PlayerStats", PlayerStats::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_PlayerUnlocks, "dice.hfe.PlayerUnlocks", PlayerUnlocks::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_SearchForPlayer, "dice.hfe.SearchForPlayer", SearchForPlayer::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_LeaderBoard, "dice.hfe.LeaderBoard", LeaderBoard::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_PlayerUnlockInfo, "dice.hfe.PlayerUnlockInfo", PlayerUnlockInfo::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_PlayerRankInfo, "dice.hfe.PlayerRankInfo", PlayerRankInfo::create);
        regInfos.push_back(regInfo);
    }
    {
        auto regInfo = ClassRegInfo(CID_ModInfo, "dice.hfe.ModInfo", ModInfo::create);
        regInfos.push_back(regInfo);
    }
    */
}
...
void ModuleGame::handleEvent([[maybe_unused]] EventCategory p_Category, [[maybe_unused]] uint32_t p_ID, [[maybe_unused]] EventNode* p_EventNode, [[maybe_unused]] void* p_Data)
{
}
