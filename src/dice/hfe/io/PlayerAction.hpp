...
namespace dice::hfe::io
{
	...
	public:
		...
		void setAxis(PlayerInput& input, PlayerInputMap id)
		{
			...
			m_axisInputs[static_cast<size_t>(id)] =
				convertAxisToInternalResolution(axis ? *axis : 0.0f);
		}

		void getAxis(PlayerInput& input, PlayerInputMap id)
		{
			float axis =
				m_axisInputs[static_cast<size_t>(id)] / AXIS_RESOLUTION;
	...
	static_assert(
		sizeof(PlayerAction) ==
		0x1C);	  // XXX: BF2 mallocs 0x20 for some reason
}	 // namespace dice::hfe::io
