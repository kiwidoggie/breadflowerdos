...
namespace dice
{
	namespace hfe
	{
		namespace io
		{
			...
			class FileChangeManager : public IFileChangeManager, IDirectoryChangeListener {
			public:
				struct File {};
				struct DirChange {};
			...
			public:
				...
				virtual std::string const& addListener(IFileChangeListener*, std::string const&, uint32_t) override;
				virtual bool removeListener(IFileChangeListener*, std::string const&) override;
				virtual bool removeListener(dice::hfe::io::IFileChangeListener*) override;
				...
				virtual void onDirectoryChange(std::string const&, bool, uint32_t) override;
				virtual bool allowFileChange(std::string const&) override;
			};
