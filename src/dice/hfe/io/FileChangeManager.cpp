...
const std::string& FileChangeManager::addListener(
	IFileChangeListener*, const std::string& fileName, uint32_t)
{
	if (!m_initialized)
	{
		init();
...
bool FileChangeManager::removeListener(IFileChangeListener*, const std::string&)
{
	// TODO: Implement
	return false;
}
...
void FileChangeManager::onDirectoryChange(const std::string&, bool, uint32_t)
{
	// TODO: Implement
}

bool FileChangeManager::allowFileChange([[maybe_unused]] const std::string&)
{
	return true;
}
