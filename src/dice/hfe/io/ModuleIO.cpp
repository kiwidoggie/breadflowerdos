...
void ModuleIO::getClassList(std::vector<ClassRegInfo>& regInfos)
{
	 ...
	 * "dice.hfe.io.InputDeviceManager.Null", NullInputDeviceManager::create);

	 * regInfos.push_back(regInfo);
    }
    {
        auto regInfo =
	 * ClassRegInfo(CID_NullResourceManager, "dice.hfe.io.ResourceManager.Null",
	 * NullResourceManager::create);
        regInfos.push_back(regInfo);
    }

	 * {
        auto regInfo = ClassRegInfo(CID_NullCacheManager,
	 * "dice.hfe.io.CacheManager.Null", NullCacheManager::create);
...
void ModuleIO::getSingletonList(std::vector<SingletonRegInfo>& regInfos)
{
	...
	/*
    {
        auto regInfo = SINGLETON_REG_INFO("FileManager",
	 * g_fileManager, IID_IFileManager, CID_FileManager, 1);

	 * regInfos.push_back(regInfo);
    }
    {
        auto regInfo =
	 * SINGLETON_REG_INFO("FileChangeManager", g_fileChangeManager,
	 * IID_IFileChangeManager, CID_FileChangeManager, 1);

	 * regInfos.push_back(regInfo);
    }
    {
        auto regInfo =
	 * SINGLETON_REG_INFO("ResourceManager", g_resourceManager,
	 * IID_IResourceManager, CID_NullResourceManager, 1);

	 * regInfos.push_back(regInfo);
    }
    {
        auto regInfo =
	 * SINGLETON_REG_INFO("CacheManager", g_cacheManager, IID_ICacheManager,
	 * CID_NullCacheManager, 1);
        regInfos.push_back(regInfo);
    }
 {

	 * auto regInfo = SINGLETON_REG_INFO("AsyncMultiStreamer",
	 * g_asyncMultiStreamer, IID_IAsyncMultiStreamer, CID_AsyncMultiStreamer,
	 * 1);
        regInfos.push_back(regInfo);
    }
    {
	 ...
	 * g_controlMapManager, IID_IControlMapManager, CID_ControlMapManager, 1);

	 * regInfos.push_back(regInfo);
    }
    {
        auto regInfo =
	 * SINGLETON_REG_INFO("MainConsole", g_mainConsole);
    ...
    {
        auto regInfo =
	 * SINGLETON_REG_INFO("Lexicon", g_lexicon, IID_ILexicon, CID_ExcelLexicon,
	 * 2);
        regInfos.push_back(regInfo);
    }
    */
